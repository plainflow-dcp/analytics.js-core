...
var _plainflow = global.plainflow;
...
Analytics.prototype.trackClick = Analytics.prototype.trackLink = function(links, event, properties) {
  ...
  each(function(el) {
    if (type(el) !== 'element') {
      throw new TypeError('Must pass HTMLElement to `plainflow.trackLink`.');
    }
...
Analytics.prototype.trackSubmit = Analytics.prototype.trackForm = function(forms, event, properties) {
  ...
  var self = this;
  each(function(el) {
    if (type(el) !== 'element') throw new TypeError('Must pass HTMLElement to `plainflow.trackForm`.');
    function handler(e) {
      prevent(e);
...
Analytics.prototype._parseQuery = function(query) {
  ...
  var traits = pickPrefix('pfl_trait_', q);
  var props = pickPrefix('pfl_prop_', q);
  // Trigger based on callable parameters in the URL
  if (q.pfl_uid) this.identify(q.pfl_uid, traits);
  if (q.pfl_event) this.track(q.pfl_event, props);
  if (q.pfl_aid) user.anonymousId(q.pfl_aid);
  return this;
